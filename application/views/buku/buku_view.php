                    ...
                    <table id="example1" class="table table-bordered table-striped table" width="100%">
                        ...
                        <?php $no=1;foreach($buku->result_array() as $isi){?>
                            <tr>
                                ...
                                <td><?= $isi['tgl_masuk'];?></td>
									<td <?php if($this->session->userdata('level') == 'Petugas'){?>style="width:25%;"<?php }?>>
								
									<?php if($this->session->userdata('level') == 'Petugas'){?>
									<a href="<?= base_url('data/bukuedit/'.$isi['id_buku']);?>"><button class="btn btn-warning"><i class="fa fa-edit">Update</i></button></a>
