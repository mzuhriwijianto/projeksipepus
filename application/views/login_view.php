...
<div class="login-box">
  ...
  <div class="login-logo">
    <a href="index.php" style="color: blue;"><br/><b>SISTEM INFORMASI PERPUSTAKAAN</b></a>
  </div>
  ...
  <br/>
  <footer>
    <div class="login-box-body text-center bg-blue"><b>KELOMPOK 4</b></a>
       <a style="color: warning;"> 
    </div>
  </footer>
</div>
<!-- /.login-box -->
