							...
							<div class="row">
								<div class="col-sm-6">
									...
									<div class="form-group">
										...
										<input type="text" class="form-control" name="lahir" required="required" placeholder="Contoh : Bojonegoro">
									</div>
									<div class="form-group">
								...
								<div class="col-sm-6">
									...
									<div class="form-group">
										<label>E-mail</label>
										<input type="email" class="form-control" name="email" required="required" placeholder="Contoh : admin@kelompok4-RPL.com">
									</div>
									<div class="form-group">
